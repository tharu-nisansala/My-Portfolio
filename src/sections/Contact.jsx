...
function Contact() {
  ...
  return (  
    <section id="contact" className="bg-black py-5">      
      <h1 className="text-amber-500 text-center text-3xl md:text-4xl font-bold">Contact</h1>
      <div className="max-w-6xl mx-auto md:px-3 px-8 py-10 text-white md:flex block justify-center items-center md:gap-10 lg:gap-16 xl:gap-20">
        ...
        >
        <div className="rounded-3xl border-1 border-black shadow-[0_0_10px_rgba(245,158,11,0.6)]">
          <div className="rounded-3xl p-5 bg-[#0a0a10]">
            ...
            <div className='p-2 flex items-center gap-8 mt-3'>
              ...
              <a href="https://github.com/tharu-nisansala" target="_blank" rel="noopener noreferrer" className="text-gray-200 hover:text-fuchsia-300 no-underline">
                <p className='font-bold text-white'>Github</p>
                <span className="text-amber-500 hover:text-amber-400">https://github.com/tharu-nisansala</span>
              </a>
            </div>
            <div className='p-2 flex items-center gap-8 mt-3'>
              <FaLinkedin className='text-2xl ml-3' />
              <a href="https://www.linkedin.com/in/tharushi-nisansala-5818982a6" target="_blank" rel="noopener noreferrer" className="text-gray-200 hover:text-fuchsia-300">
                <p className='font-bold text-white'>LinkedIn</p>
                <span className="text-amber-500 hover:text-amber-400">https://www.linkedin.com/in/tharushi-nisansala-5818982a6</span>
              </a>
            </div>
          </div>
        </div>
        ...
        <div className="p-1 rounded-3xl border-1 border-black shadow-[0_0_10px_rgba(245,158,11,0.6)] mt-10">
          <div className="rounded-3xl p-8 bg-[#0a0a10]">
            <p className='text-amber-500 font-bold mb-10'>Or send me a quick message using the contact form below</p>
...
>
  ...
  <span className="absolute inset-0 bg-amber-400 scale-x-0 group-hover:scale-x-100 origin-left 
                   transition-transform duration-300 rounded-lg"></span>
</button>
        ...
        <div className="fixed inset-0 flex items-center justify-center bg-transparent z-50">
          <div className="bg-white rounded-lg shadow-lg p-6 w-80 text-center animate-fadeIn">
            ...
            <div className="flex justify-center mb-3">
              <div className={`w-12 h-12 flex items-center justify-center rounded-full border-2 ${alert.success ? "border-green-500" : "border-red-500"}`}>
                <svg
                  className={`w-6 h-6 ${alert.success ? "text-green-500" : "text-red-500"}`}
                  fill="none"
                  stroke="currentColor"
                  strokeWidth="3"
                  viewBox="0 0 24 24"
