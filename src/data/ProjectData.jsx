...
const Individualprojects = [
  {
    ...
    description: "Designed and developed a visually engaging portfolio website that highlights my technical skills, academic background, and software development projects. The site incorporates advanced animations, seamless navigation, and responsive layouts to provide an immersive user experience across all devices.",
  ...
  },
  {
    ...
    description: "This is a self-study project built using Next.js, MongoDB, and NextAuth It demonstrates how to build a simple blog dashboard where users can create, view, and delete posts.Update functionality and further improvements are in progress.",
    techStack: ["Next.js 16","React","Vite", "MongoDB & Mongoose","CSS","NextAuth.js","SWR"],
...
const GroupProjects = [
   {
    id: 1,
    img: LMSimg,
    title: "Learning Management System (LMS) for Diploma Programs at Veritas International Campus",
